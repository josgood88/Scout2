...
namespace Library {
   ...
   public sealed class Config {
      ...
      public string BillsFolder     { get { return own["bills_folder"]; } }
      public string DatabaseFolder  { get { return own["database_folder"]; } }
      public string DownloadsFolder { get { return own["downloads_folder"]; } }
      public string HtmlFolder      { get { return own["html_folder"]; } }
      public string LegSite         { get { return own["leg_site"]; } }
      public string NegativeFile    { get { return own["negative_file"]; } }
      public string PositiveFile    { get { return own["positive_file"]; } }
      public string ScoutFile       { get { return own["scout_file"]; } }
